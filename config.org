...
I like a high contrast dark colour scheme and a san serif mono
space font, also modified are the opening frame size to fit 
on my notebook amongst other settings.

** Themes

Cyber punk has a good contrasty appearance they identify org mode as  
specially-tailored but not Python or Fortran.  The jury is out as yet.
